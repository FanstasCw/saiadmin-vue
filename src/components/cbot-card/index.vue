  ...
  <a-card class="sbot-card card-hover overflow-hidden" :class="{ 'sbot-card--active': isActive }">
    ...
    <div class="p-5">
      ...
      <div class="grid grid-cols-2 gap-2 text-sm mb-4">
        <p>
          <span class="text-gray-500">{{ t('bot.coinBot.openPositionCont') }}: </span>{{ robot.open_position_cont }}
        </p>
        <p>
          <span class="text-gray-500">{{ t('bot.coinBot.positionCont') }}: </span>{{ parseFloat(robot.position_cont) }}
        </p>
        <p>
          <span class="text-gray-500">{{ t('bot.coinBot.availableCont') }}: </span>{{ robot.available_cont }}
        </p>
      </div>
